...
void gfs_advance_tracers (GfsSimulation * sim, gdouble dt)
{
  ...
  while (i) { //while loop goes over each variable. i.e. u,v,w,T
...
static void simulation_run (GfsSimulation * sim)
{
  ...
  if (sim->time.i == 0) {
    gfs_approximate_projection (domain,  //gfs_approximate_projection corrects cell centered velocity to be divergence free. Returns potenial pressure as well
